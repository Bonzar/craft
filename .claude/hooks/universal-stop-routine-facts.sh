...
reason="Перед завершением сверь секцию «Факты завершения» своего SKILL-дока: каждый факт проверен чтением или командой, не заявлен. Несходящийся факт — блокер в отчёте, не примечание. Сверил — завершай, повторное завершение пройдёт."
