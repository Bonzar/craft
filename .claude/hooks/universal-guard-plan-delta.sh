...
#
# Нормализация до хеша: код-фенсы вырезаются (размеченный пример в заборе — не юниты
# этого плана), пустые строки не учитываются (иначе разделитель перед следующим
