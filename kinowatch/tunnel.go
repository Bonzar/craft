...
var needsTunnel = map[string]bool{
	kindCinemaPark: true, // kinoteatr.ru рвёт соединение с иностранного адреса
	"illuzion":     true, // то же поведение
	"luxor":        true, // 403 geoblocked, плюс JS-челлендж за туннелем
}
