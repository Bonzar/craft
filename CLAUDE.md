...
craftdocs://-диплинком. Какую форму применять — задаёт правило «Формат
Craft-ссылки» в системной зоне Craft («Общение с Владом»); расхождение
правила с этим фактом — сигнал Владу, не повод молча изобретать свой формат.
