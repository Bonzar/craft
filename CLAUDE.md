...
ведёт на claude.ai. Рабочие формы: код-спан с диплинком (копировать и открыть
вручную) или https-редиректор, прыгающий на craftdocs://. Какую форму
применять — задаёт правило ссылок в системной зоне Craft («Работа с Craft:
запись»); расхождение правила с этим фактом — сигнал Владу, не повод молча
изобретать свой формат.
